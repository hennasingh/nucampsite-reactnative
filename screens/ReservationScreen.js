...
import { Animated, Text, View, ScrollView, StyleSheet, Switch, Button, Modal } from 'react-native'
...
export default function ReservationScreen() {
    ...
    const [hikeIn, setHikeIn ] = React.useState(false);
            ...
            >
                ...
                >
                    <View style={styles.modal}>
                        ...
                        <Text style={styles.modalText}>
                            Date: {date.toLocaleDateString('en-UD')}
                        </Text>
                        <Button
                            onPress={() => {
                                setShowModal(!showModal);
